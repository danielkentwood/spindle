...
* Document: A document is a file that contains any combimation of text, images, audio, video, etc.
* DocumentSpan: A span is an arbitrary, contiguous range of characters in a document.
* DocumentSection: A section is a semantically meaningful (e.g., paragraph, section, chapter, etc.) contiguous range of characters in a document.
